...
//	 print "<!-- using date_default_timezone_set(\"". $SITE['tz']. "\") -->\n";
  ...
  $coreDirs = array(
  'w34highcharts' => 'Highcharts Charts scripts',
  'w34highcharts/json' => 'Highcharts charts raw data',
  'w34highcharts/json_day' => 'Highcharts charts raw day data',
  'css' => 'Weather34 CSS stylesheets and SVG image collections',
  'css/aqi' => 'Weather34 SVG images for AQI display',
  'css/darkskyicons' => 'Weather34 SVG images for DarkSky forecasts',
  'css/fonts' => 'Weather34 fonts',
  'css/icons' => 'Weather34 SVG images',
  'css/mouse' => 'Weather34 SVG images for mouse cursor',
  'css/rain' => 'Weather34 SVG images for rain gauge display',
  'css/windicons' => 'Weather34 SVG images for wind direction',
  'img' => 'Weather34 images',
  'img/flags' => 'Weather34 country flag images',
  'js' => 'Weather34 JavaScripts',
  'jsondata' => 'Weather34 downloaded JSON data files',
  'languages' => 'Weather34 Language plugins',
  'metar' => 'Weather34 METAR scripts',
  );
